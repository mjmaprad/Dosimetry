...
public:
  inline G4bool GetIsFirstScintillatorX() const {return fFirstScintillatorX;}
  inline void   SetIsFirstScintillatorX(G4bool b) {fFirstScintillatorX = b;}

private:
  G4bool    fFirstScintillatorX;
};
